...
- [Dependency Injection](/api/composition-api-dependency-injection.html), e.g. `provide()` and `inject()`, that allow us to leverage Vue's dependency injection system while using Reactivity APIs.
